...
document.getElementById("item-container").addEventListener("click", (event) => {
...
function goodAnimation(element) {
	...
	element.className = "animated-position";
}

function bestAnimation(element) {
	element.style.transform = "translate(10px, 10px) scale(1.2)";
}
